        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 pt-5 page-next-level text-center">
                    <h3 class="pt-3 BebasNeue text-white">Speeches</h3>
                    <div class="page-next text-light"><a href="javascript:void(0)">Media</a>/<span>Speeches</span></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row clearfix">
                        <div class="col-lg-4 col-md-4">
                            <div class="card mb-4 border-0 shadow-sm">
                                <div class="thumbnail">
                                    <img src="uploads/photo/1.jpg" class="card-img-top"
                                         alt="...">
                                    <a data-fancybox href="#"></i></a>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. | Solaiman Salim</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">

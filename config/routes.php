...
$routes->scope('/', function (RouteBuilder $builder) {
    ...
    $builder->connect('/home', ['controller' => 'Fronts', 'action' => 'home']);
    $builder->connect('/about', ['controller' => 'Fronts', 'action' => 'about']);
    $builder->connect('/contact', ['controller' => 'Fronts', 'action' => 'contact']);
    $builder->connect('/event', ['controller' => 'Fronts', 'action' => 'event']);
    $builder->connect('/news', ['controller' => 'Fronts', 'action' => 'news']);
